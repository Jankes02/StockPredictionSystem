...
%DIF DEL paper_OLD.tex   Tue Aug  4 01:18:47 2026
%DIF ADD paper.tex       Thu Aug  6 00:59:01 2026
...
%DIF 185a185-269
% Gradient-boosted-trees (GBM) baseline on WIG20 %DIF > 
\newcommand{\GBMtest}{\ensuremath{0.04}} %DIF > 
\newcommand{\GBMsharpe}{\ensuremath{0.47}} %DIF > 
\newcommand{\GBMmdd}{\ensuremath{-0.05}} %DIF > 
\newcommand{\GBMcalmar}{\ensuremath{0.45}} %DIF > 
\newcommand{\GBMtrades}{\ensuremath{34}} %DIF > 
\newcommand{\GBMhorizon}{\ensuremath{1}} %DIF > 
\newcommand{\GBMband}{\ensuremath{0.03}} %DIF > 
\newcommand{\PensVsGBM}{\ensuremath{0.107}} %DIF > 
\newcommand{\PensVsGBMsharpe}{\ensuremath{0.210}} %DIF > 
\newcommand{\PGBMvsBH}{\ensuremath{0.820}} %DIF > 
\newcommand{\PGBMvsLSTM}{\ensuremath{0.621}} %DIF > 
% GBM baseline on the FTSE 100 %DIF > 
\newcommand{\FtseGBMtest}{\ensuremath{0.35}} %DIF > 
\newcommand{\FtseGBMsharpe}{\ensuremath{1.63}} %DIF > 
\newcommand{\FtseGBMmdd}{\ensuremath{-0.10}} %DIF > 
\newcommand{\FtseGBMcalmar}{\ensuremath{1.88}} %DIF > 
\newcommand{\FtseGBMtrades}{\ensuremath{0}} %DIF > 
\newcommand{\FtseGBMhorizon}{\ensuremath{3}} %DIF > 
\newcommand{\FtseGBMband}{\ensuremath{0.03}} %DIF > 
\newcommand{\FtsePensVsGBM}{\ensuremath{0.951}} %DIF > 
\newcommand{\FtsePensVsGBMsharpe}{\ensuremath{0.682}} %DIF > 
\newcommand{\FtsePGBMvsBH}{\ensuremath{0.144}} %DIF > 
\newcommand{\FtsePGBMvsLSTM}{\ensuremath{0.083}} %DIF > 
% Weight sensitivity on WIG20 (Section: weight sensitivity) %DIF > 
\newcommand{\WSPerturbN}{\ensuremath{16}} %DIF > 
\newcommand{\WSPerturbTRMin}{\ensuremath{0.14}} %DIF > 
\newcommand{\WSPerturbTRMax}{\ensuremath{0.30}} %DIF > 
\newcommand{\WSPerturbSharpeMin}{\ensuremath{0.70}} %DIF > 
\newcommand{\WSPerturbSharpeMax}{\ensuremath{1.38}} %DIF > 
\newcommand{\WSFixedBelowBH}{\ensuremath{2}} %DIF > 
\newcommand{\WSFixedN}{\ensuremath{20}} %DIF > 
\newcommand{\WSEqualTR}{\ensuremath{0.25}} %DIF > 
\newcommand{\WSEqualSharpe}{\ensuremath{1.16}} %DIF > 
\newcommand{\WSEqualMDD}{\ensuremath{-0.06}} %DIF > 
\newcommand{\WSInvertedTR}{\ensuremath{0.23}} %DIF > 
\newcommand{\WSInvertedSharpe}{\ensuremath{1.23}} %DIF > 
\newcommand{\WSInvertedMDD}{\ensuremath{-0.05}} %DIF > 
\newcommand{\WSOptTR}{\ensuremath{0.25}} %DIF > 
\newcommand{\WSOptSharpe}{\ensuremath{1.18}} %DIF > 
\newcommand{\WSOptMDD}{\ensuremath{-0.05}} %DIF > 
\newcommand{\WSOptWtrend}{\ensuremath{1.30}} %DIF > 
\newcommand{\WSOptWmom}{\ensuremath{0.80}} %DIF > 
\newcommand{\WSOptWmr}{\ensuremath{0.80}} %DIF > 
\newcommand{\WSOptWvol}{\ensuremath{0.50}} %DIF > 
\newcommand{\WSOptTrainTR}{\ensuremath{0.59}} %DIF > 
\newcommand{\WSIvTR}{\ensuremath{0.25}} %DIF > 
\newcommand{\WSIvSharpe}{\ensuremath{1.16}} %DIF > 
\newcommand{\WSIvMDD}{\ensuremath{-0.06}} %DIF > 
\newcommand{\WSIvWtrend}{\ensuremath{1.02}} %DIF > 
\newcommand{\WSIvWmom}{\ensuremath{1.00}} %DIF > 
\newcommand{\WSIvWmr}{\ensuremath{1.00}} %DIF > 
\newcommand{\WSIvWvol}{\ensuremath{0.98}} %DIF > 
% Weight sensitivity on the FTSE 100 %DIF > 
\newcommand{\FtseWSPerturbTRMin}{\ensuremath{0.07}} %DIF > 
\newcommand{\FtseWSPerturbTRMax}{\ensuremath{0.17}} %DIF > 
\newcommand{\FtseWSPerturbSharpeMin}{\ensuremath{0.69}} %DIF > 
\newcommand{\FtseWSPerturbSharpeMax}{\ensuremath{1.54}} %DIF > 
\newcommand{\FtseWSFixedBelowBH}{\ensuremath{3}} %DIF > 
\newcommand{\FtseWSFixedN}{\ensuremath{20}} %DIF > 
\newcommand{\FtseWSEqualSharpe}{\ensuremath{1.07}} %DIF > 
\newcommand{\FtseWSInvertedSharpe}{\ensuremath{1.23}} %DIF > 
\newcommand{\FtseWSOptTR}{\ensuremath{0.13}} %DIF > 
\newcommand{\FtseWSOptSharpe}{\ensuremath{1.16}} %DIF > 
\newcommand{\FtseWSIvTR}{\ensuremath{0.09}} %DIF > 
\newcommand{\FtseWSIvSharpe}{\ensuremath{0.93}} %DIF > 
% Confidence validation on WIG20 (training window) %DIF > 
\newcommand{\ConfN}{\ensuremath{29{,}063}} %DIF > 
\newcommand{\ConfPooledHit}{\ensuremath{0.498}} %DIF > 
\newcommand{\ConfPooledHitFive}{\ensuremath{0.510}} %DIF > 
\newcommand{\ConfRhoMin}{\ensuremath{-0.035}} %DIF > 
\newcommand{\ConfRhoMax}{\ensuremath{0.016}} %DIF > 
\newcommand{\ConfRhoMaxAbs}{\ensuremath{0.035}} %DIF > 
% Confidence validation on the FTSE 100 (training window) %DIF > 
\newcommand{\FtseConfRhoMaxAbs}{\ensuremath{0.027}} %DIF > 
\newcommand{\FtseConfPooledHit}{\ensuremath{0.502}} %DIF > 
% Selection-objective comparison %DIF > 
\newcommand{\ObjSharpeMode}{\texttt{aggressive}} %DIF > 
\newcommand{\ObjSharpeMinConf}{\ensuremath{0.05}} %DIF > 
\newcommand{\ObjCalmarMode}{\texttt{aggressive}} %DIF > 
\newcommand{\ObjCalmarMinConf}{\ensuremath{0.05}} %DIF > 
\newcommand{\FtseObjSharpeMode}{\texttt{aggressive}} %DIF > 
\newcommand{\FtseObjSharpeMinConf}{\ensuremath{0.15}} %DIF > 
\newcommand{\FtseObjCalmarMode}{\texttt{aggressive}} %DIF > 
\newcommand{\FtseObjCalmarMinConf}{\ensuremath{0.15}} %DIF > 
%DIF -------
...
\begin{abstract}
We study a multi-agent decision support system for stock trading on the Warsaw Stock Exchange (WSE), \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{an underrepresented }\DIFaddend Central and Eastern European market\DIFdelbegin \DIFdel{underrepresented in the algorithmic trading literature}\DIFdelend . Five heterogeneous technical-analysis agents feed a transparent, confidence-weighted decision agent \DIFdelbegin \DIFdel{grounded in }\DIFdelend \DIFaddbegin \DIFadd{motivated by }\DIFaddend forecast-combination theory. The primary contribution is a rigorous and reusable evaluation framework \DIFdelbegin \DIFdel{, demonstrated through an in-depth empirical study of this ensemble. The framework }\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend addresses four recurring weaknesses of backtested trading studies \DIFdelbegin \DIFdel{: }\DIFdelend \DIFaddbegin \DIFadd{- }\DIFaddend in-sample parameter selection, absent transaction costs, neglect of risk-adjusted performance, and lack of significance tests \DIFdelbegin \DIFdel{. Evaluation uses }\DIFdelend \DIFaddbegin \DIFadd{- demonstrated through an in-depth empirical study of this ensemble. Evaluation combines }\DIFaddend anchored walk-forward tuning\DIFdelbegin \DIFdel{of decision-agent parameters}\DIFdelend , calibrated commissions and slippage, Sharpe, Sortino, Calmar, \DIFaddbegin \DIFadd{and }\DIFaddend Martin ratios and the Ulcer Index, a volatility-matched comparison, bootstrap confidence intervals, \DIFdelbegin \DIFdel{and decompositioninto bull, correction, and sideways regimes}\DIFdelend \DIFaddbegin \DIFadd{regime decomposition, leave-one-agent-out ablation, and sensitivity analyses over decision-agent weights, selection objective, and costs, plus an empirical audit of the confidence heuristic}\DIFaddend . On \OOSDays{} held-out trading days for WIG20, the ensemble trails passive buy-and-hold on gross total return in a bull-dominated window but improves every risk-adjusted metric \DIFdelbegin \DIFdel{considered }\DIFdelend and, once scaled ex ante to benchmark volatility, total return as well; these differences are economically meaningful yet not statistically significant on a single sub-two-year window. Regime analysis attributes the profile to smaller losses in corrections and gains in sideways phases, offset by lower bull exposure. The same qualitative pattern appears in external validation on the FTSE 100 under UK-specific costs, and the ensemble remains competitive with \DIFdelbegin \DIFdel{an LSTM directional baseline }\DIFdelend \DIFaddbegin \DIFadd{LSTM and gradient-boosted-tree baselines }\DIFaddend under the identical protocol. \DIFdelbegin \DIFdel{Ablation and cost-sensitivity checks confirm robustness. }\DIFdelend The results support \DIFdelbegin \DIFdel{theory-grounded }\DIFdelend \DIFaddbegin \DIFadd{theory-motivated }\DIFaddend ensembles as risk-aware decision support rather than return enhancers.
\end{abstract}

\begin{keywords}
Algorithmic trading, cross-market validation, decision support systems, forecast combination, multi-agent systems, risk-adjusted performance, walk-forward validation, Warsaw Stock Exchange.
\end{keywords}
...
We map the trading problem onto this framework as follows. At a given date $t$ and symbol $s$, each signal agent $a$ produces a directional signal $\sigma_{a,s}(t) \in \{-1, 0, +1\}$ together with a confidence value $c_{a,s}(t) \in [0, 1]$. We \DIFdelbegin \DIFdel{interpret }\DIFdelend \DIFaddbegin \DIFadd{read }\DIFaddend $c_{a,s}(t)$ as a \DIFaddbegin \DIFadd{heuristic, }\DIFaddend monotone, bounded proxy for the inverse variance of the agent as a forecaster of the next-period directional move: higher confidence means the agent\DIFdelbegin \DIFdel{believes its }\DIFdelend \DIFaddbegin \DIFadd{'s indicator is further inside its active region, which the design treats as a sign that the }\DIFaddend forecast is more \DIFdelbegin \DIFdel{precise }\DIFdelend \DIFaddbegin \DIFadd{reliable }\DIFaddend at that moment. The decision agent aggregates these forecasts into a combined score
\begin{equation}
...
\DIFaddbegin \DIFadd{Two caveats define the status of this mapping and should be kept in mind throughout the paper. First, the signals and confidence values are heuristic transformations of price history, not statistically calibrated forecasts: no agent estimates a predictive distribution, and no confidence value is fitted to data. The connection to classical forecast-combination theory is therefore }\emph{\DIFadd{conceptual}} \DIFadd{rather than literal: \eqref{eq:combined_variance} motivates the architecture (methodologically heterogeneous agents whose errors are imperfectly correlated) and the linear form of the score \eqref{eq:score}, but it does not by itself guarantee that $c_{a,s}(t)$ behaves as an inverse-variance estimate. Second, whether higher confidence in fact identifies more accurate signals is an empirical question, which Section~\ref{subsec:confvalid} tests directly by relating confidence values to realized directional accuracy on the training window. The headline hypotheses below are deliberately formulated so that they do not depend on the calibration of the confidence heuristic: they concern the risk-adjusted performance of the pooled ensemble, which \eqref{eq:combined_variance} predicts from error diversity alone.
}

\DIFaddend \subsection{Hypotheses}
...
H1 is stated against buy-and-hold WIG20, because that is the primary panel; Section~\ref{subsec:ftse} replicates the same risk-adjusted comparisons on the FTSE 100 as supplementary external evidence. H2 and H3 are evaluated on WIG20 only.
...
\end{aligned}
\end{equation}
The weights encode a fixed prior on the relative directional reliability of each methodological family, and their ordering follows directly from the empirical literature rather than from any in-sample search. Trend-following receives the largest weight because time-series momentum is among the most robust and persistent return predictors documented across equity markets and horizons \cite{moskowitz2012,asness2013}, and daily index constituents such as the WIG20 blue chips tend to exhibit sustained directional regimes. Momentum on a shorter horizon receives a unit weight as the reference family. Mean reversion is weighted below momentum because overbought and oversold rules are informative mainly in range-bound phases and are frequently wrong during strong trends. Volatility receives the smallest weight because band-based signals respond to dispersion rather than to direction and therefore carry the least directional information of the four families. The four levels are intentionally coarse, equally spaced multiples that keep the weights interpretable and the degrees of freedom low; they are held fixed across every symbol, regime, and evaluation window, and are never tuned on the test data. \DIFdelbegin \DIFdel{The robustness of }\DIFdelend \DIFaddbegin \DIFadd{Retaining a fixed prior instead of estimating the weights is additionally supported by the forecast-combination literature, in which simple fixed weights are notoriously difficult to beat with estimated ones because weight-estimation error tends to consume the gains it promises - the }\emph{\DIFadd{forecast combination puzzle}} \DIFadd{\mbox{%DIFAUXCMD
\cite{smithwallis2009,claeskens2016}}\hskip0pt%DIFAUXCMD
. The sensitivity of the results to }\DIFaddend this fixed scheme is examined \DIFdelbegin \DIFdel{by }\DIFdelend \DIFaddbegin \DIFadd{empirically in Section~\ref{subsec:weights}, where each family weight is perturbed by up to $\pm 50\%$ and the whole vector is replaced by equal, inverted, in-sample-optimized, and inverse-variance-estimated alternatives; }\DIFaddend the leave-one-agent-out ablation in Section~\ref{subsec:ablation} \DIFdelbegin \DIFdel{, and the possibility of replacing it with adaptive or learned weights is discussed }\DIFdelend \DIFaddbegin \DIFadd{covers the limiting case of removing an agent entirely, and regime-conditional weighting is discussed as future work }\DIFaddend in Section~\ref{sec:limitations}. The score is then compared against mode-dependent thresholds to produce the final decision:
\begin{equation}
\mathrm{action} =
\begin{cases}
...
\DIFaddbegin \DIFadd{Total return is deliberately retained as the selection objective even though the paper evaluates the strategy primarily on risk-adjusted metrics. The reason is statistical rather than conceptual. On a low-dimensional grid of $21$ configurations, in-sample total return is a simple, low-variance ranking criterion, whereas ratio statistics such as the Sharpe ratio carry substantial estimation error on samples of this length \mbox{%DIFAUXCMD
\cite{lo2002} }\hskip0pt%DIFAUXCMD
and become degenerate for configurations that trade rarely: the }\emph{\DIFadd{passive}} \DIFadd{mode produces no trades at any threshold (Table~\ref{tab:grid_train}), so its in-sample Sharpe ratio is undefined rather than merely low, and a risk-adjusted objective would have to break such ties arbitrarily. To verify that this choice is not load-bearing, Section~\ref{subsec:objective} re-runs the selection under Sharpe-ratio and Calmar-ratio objectives on the identical grid and shows that the selected configuration - and therefore every out-of-sample number in the paper - is unchanged on both markets.
}

\DIFaddend As a robustness check, we additionally report the results of an anchored, expanding walk-forward with three folds. For each fold $k \in \{1, 2, 3\}$, the test slice is one of three roughly equal chronological slices of the held-out window, and the training window spans $2021/05/26$ up to the day before the test slice begins. A fresh grid search is performed on each fold and the winning configuration is evaluated on the test slice of that fold. The objective of this exercise is to show that the headline configuration is not an artifact of a particular single split.
...
Three families of baselines are used. The first is \emph{index buy-and-hold}: on WIG20 the benchmark invests the initial cash into the WIG20 index on the first date of the test window and holds the position until the end; on the FTSE replication the same rule applies to the FTSE 100 index. Buy-and-hold is a standard benchmark in the evaluation of trading strategies \cite{dichtl2020}. The second family is a set of \emph{single-agent} runs in which the decision agent receives signals from only one signal agent; this produces five baselines, one per indicator. In addition, we run five \emph{leave-one-agent-out} configurations, each of which removes one agent from the ensemble. The third family \DIFdelbegin \DIFdel{is a }\DIFdelend \DIFaddbegin \DIFadd{comprises two }\DIFaddend \emph{\DIFdelbegin \DIFdel{deep-learning baseline}\DIFdelend \DIFaddbegin \DIFadd{machine-learning baselines}\DIFaddend }, described next. All baselines are evaluated on the same test window on each market, use market-specific transaction costs described in Sections~\ref{subsec:costs} and~\ref{subsec:ftse}, and adopt the same decision-agent configuration selected by the walk-forward protocol. The only exceptions are buy-and-hold, which has no decision-agent parameters, and the \DIFdelbegin \DIFdel{deep-learning baseline, which replaces }\DIFdelend \DIFaddbegin \DIFadd{machine-learning baselines, which replace }\DIFaddend the decision agent with a learned classifier.

\subsubsection{\DIFdelbegin \DIFdel{Deep-Learning Baseline}\DIFdelend \DIFaddbegin \DIFadd{Machine-Learning Baselines}\DIFaddend }
\label{subsec:lstm}
...
\DIFaddbegin \DIFadd{The second machine-learning baseline is a gradient-boosted-trees (GBM) directional classifier \mbox{%DIFAUXCMD
\cite{friedman2001}}\hskip0pt%DIFAUXCMD
, implemented with LightGBM \mbox{%DIFAUXCMD
\cite{ke2017lightgbm}}\hskip0pt%DIFAUXCMD
. Gradient-boosted trees are consistently among the strongest learners on tabular financial features in large-scale empirical comparisons \mbox{%DIFAUXCMD
\cite{krauss2017,gukellyxiu2020}}\hskip0pt%DIFAUXCMD
, which makes them a natural, structurally different complement to the recurrent LSTM. For each symbol and day the model consumes the same causal per-day features as the LSTM, augmented with lagged copies of each feature at lags of up to $20$ trading days so that the flat feature vector carries a temporal context comparable to the LSTM lookback window, and predicts the probability that the $h$-day-ahead return is positive. Training pools feature rows across symbols, splits them chronologically into training and validation slices, applies early stopping on validation log-loss, and averages three differently seeded models. Exactly as for the LSTM, the prediction horizon and the no-trade band are selected strictly in-sample by the net-of-cost Sharpe ratio of a validation-slice portfolio simulation, and the resulting long/flat signals are executed through the same portfolio simulator under identical costs. The in-sample selection returns $h = \GBMhorizon$ and $\delta = \GBMband$ on WIG20, and $h = \FtseGBMhorizon$ and $\delta = \FtseGBMband$ on the FTSE 100.
}

\DIFaddend \subsection{Risk-Adjusted Metrics}
...
\subsection{Risk-Adjusted Comparison}
...
\DIFaddbegin \subsection{\DIFadd{Validation of the Confidence Measure}}
\label{subsec:confvalid}

\DIFadd{Section~\ref{sec:theory} motivates the score \eqref{eq:score} by reading the per-signal confidence as a heuristic proxy for inverse forecast variance. If that reading were literally correct, higher-confidence signals should be directionally right more often than lower-confidence ones. Table~\ref{tab:confvalid} tests this implication on the training window, so that no test-window information is used: for every agent, all active (non-hold) signals are pooled across symbols and dates, the directional hit rate against the next-day move is computed, and the association between confidence and correctness is measured both by a Spearman rank correlation \mbox{%DIFAUXCMD
\cite{spearman1904} }\hskip0pt%DIFAUXCMD
and by comparing the hit rates of the bottom and top confidence quintiles, in the spirit of the reliability analysis of \mbox{%DIFAUXCMD
\cite{murphywinkler1987}}\hskip0pt%DIFAUXCMD
. A rank correlation is the appropriate statistic here because correctness is binary and the confidence distributions are strongly skewed towards zero, so no linearity assumption is warranted; this complements the Pearson correlations of Section~\ref{subsec:correlations} \mbox{%DIFAUXCMD
\cite{pearson1896}}\hskip0pt%DIFAUXCMD
, which measure the association }\emph{\DIFadd{between}} \DIFadd{agents rather than between an agent's confidence and its own accuracy.
}

\begin{table}[t]
\centering
\setlength{\tabcolsep}{4pt}
\caption{\DIFaddFL{Confidence validation on the WIG20 training window at the one-day horizon. $\rho$ is the Spearman rank correlation between confidence and directional correctness, with its $p$-value; Hit (Q1) and Hit (Q5) are hit rates in the bottom and top confidence quintiles.}}
\label{tab:confvalid}
\begin{tabular}{lrccccc}
\toprule
\DIFaddFL{Agent }& \DIFaddFL{$n$ }& \DIFaddFL{Hit rate }& \DIFaddFL{$\rho$ }& \DIFaddFL{$p$ }& \DIFaddFL{Hit (Q1) }& \DIFaddFL{Hit (Q5) }\\
\midrule
\DIFaddFL{MACD }& \DIFaddFL{$1{,}405$ }& \DIFaddFL{$0.472$ }& \DIFaddFL{$+0.002$ }& \DIFaddFL{$0.955$ }& \DIFaddFL{$0.470$ }& \DIFaddFL{$0.484$ }\\
\DIFaddFL{RSI }& \DIFaddFL{$3{,}847$ }& \DIFaddFL{$0.497$ }& \DIFaddFL{$-0.035$ }& \DIFaddFL{$0.031$ }& \DIFaddFL{$0.525$ }& \DIFaddFL{$0.497$ }\\
\DIFaddFL{ROC }& \DIFaddFL{$11{,}155$ }& \DIFaddFL{$0.498$ }& \DIFaddFL{$+0.016$ }& \DIFaddFL{$0.082$ }& \DIFaddFL{$0.494$ }& \DIFaddFL{$0.520$ }\\
\DIFaddFL{Bollinger }& \DIFaddFL{$1{,}674$ }& \DIFaddFL{$0.483$ }& \DIFaddFL{$-0.004$ }& \DIFaddFL{$0.867$ }& \DIFaddFL{$0.478$ }& \DIFaddFL{$0.481$ }\\
\DIFaddFL{MA trend }& \DIFaddFL{$10{,}982$ }& \DIFaddFL{$0.505$ }& \DIFaddFL{$-0.004$ }& \DIFaddFL{$0.690$ }& \DIFaddFL{$0.503$ }& \DIFaddFL{$0.500$ }\\
\DIFaddFL{Pooled }& \DIFaddFL{$29{,}063$ }& \DIFaddFL{$0.498$ }& \DIFaddFL{$+0.003$ }& \DIFaddFL{$0.578$ }& \DIFaddFL{$0.493$ }& \DIFaddFL{$0.495$ }\\
\bottomrule
\end{tabular}
\end{table}

\DIFadd{The outcome is unambiguous: the confidence values carry no usable information about signal-level accuracy. Across }\ConfN{} \DIFadd{pooled training-window signals the hit rate is }\ConfPooledHit{}\DIFadd{, the per-agent rank correlations span $[\ConfRhoMin{}, \ConfRhoMax{}]$ with none exceeding $|\rho| = \ConfRhoMaxAbs{}$, and the top confidence quintile is not systematically more accurate than the bottom one. The only nominally significant entry in Table~\ref{tab:confvalid} (RSI, $p = 0.031$) is negative - higher confidence associates with marginally }\emph{\DIFadd{worse}} \DIFadd{calls - explains well under one percent of the variance in correctness, and does not survive a multiple-testing correction across the ten agent-horizon combinations tested, so it argues against rather than for the inverse-variance reading. The picture is unchanged at a five-day horizon (pooled hit rate }\ConfPooledHitFive{}\DIFadd{), and the FTSE~100 training window reproduces it (largest per-agent $|\rho| = \FtseConfRhoMaxAbs{}$, pooled hit rate }\FtseConfPooledHit{}\DIFadd{). Two consequences follow. First, the inverse-variance reading of the confidence values is a conceptual analogy, not an empirically calibrated property: at the level of individual signals the agents are close to uninformed forecasters at short horizons, and the magnitude of their confidence does not separate good calls from bad ones. This is consistent with the low tuned threshold ($c_{\min} = \BestMinConf{}$), which in practice acts as a mild noise filter rather than as a precision weight. Second, the risk-adjusted performance documented in the preceding subsections cannot be attributed to precision-weighted averaging; the operative mechanism is the pooling of weakly and negatively correlated signals across methodological families (Table~\ref{tab:corr}), which lowers the variance of the aggregate position irrespective of whether the individual confidence magnitudes are informative, together with the regime exposure profile that the thresholded score induces (Table~\ref{tab:regime}). Section~\ref{sec:discussion} returns to the implications of this finding for the theoretical framing of the paper.
}

\DIFaddend \subsection{Single-Agent Baselines and Leave-One-Out Ablation}
...
\subsection{\DIFdelbegin \DIFdel{Comparison with a Deep-Learning Baseline}\DIFdelend \DIFaddbegin \DIFadd{Weight Sensitivity and Alternative Weighting Schemes}\DIFaddend }
\DIFaddbegin \label{subsec:weights}

\DIFadd{The family weights $w_\kappa$ are the only fixed prior in the decision layer, so we quantify how much the headline results depend on them. Every experiment in this subsection holds the walk-forward-selected configuration (\BestMode{}, $c_{\min} = \BestMinConf{}$) fixed and varies only the weights, so that any difference is attributable to the weighting scheme alone. Three families of alternatives are evaluated on the held-out window. First, each family weight is perturbed one at a time by $\pm 25\%$ and $\pm 50\%$, giving }\WSPerturbN{} \DIFadd{perturbed configurations. Second, two fixed alternatives discard the ordering rationale of Section~\ref{subsec:decision} entirely: equal weights, and a fully inverted ordering in which volatility receives the largest weight and trend the smallest. Third, two data-driven schemes are estimated on the training window only: }\emph{\DIFadd{optimized}} \DIFadd{weights, selected by an exhaustive grid over the four family weights under the same in-sample total-return objective as the headline protocol, and }\emph{\DIFadd{inverse-variance}} \DIFadd{weights, proportional to the inverse of each family's directional error variance estimated from training-window signal outcomes, which operationalizes the classical prescription of \mbox{%DIFAUXCMD
\cite{batesgranger1969}}\hskip0pt%DIFAUXCMD
. Table~\ref{tab:weights} reports the named schemes on WIG20.
}

\begin{table}[t]
\centering
\caption{\DIFaddFL{Alternative weighting schemes on the WIG20 test window, with (mode, $c_{\min}$) fixed at the walk-forward selection. Weights are listed as (trend, momentum, mean-reversion, volatility).}}
\label{tab:weights}
\begin{tabular}{lcccc}
\toprule
\DIFaddFL{Scheme }& \DIFaddFL{Weights }& \DIFaddFL{TR }& \DIFaddFL{Sharpe }& \DIFaddFL{MDD }\\
\midrule
\DIFaddFL{Baseline }& \DIFaddFL{$(1.3, 1.0, 0.8, 0.5)$ }& \DIFaddFL{$\TRtest$ }& \DIFaddFL{$\Shtest$ }& \DIFaddFL{$\MDDtest$ }\\
\DIFaddFL{Equal }& \DIFaddFL{$(1.0, 1.0, 1.0, 1.0)$ }& \DIFaddFL{$\WSEqualTR$ }& \DIFaddFL{$\WSEqualSharpe$ }& \DIFaddFL{$\WSEqualMDD$ }\\
\DIFaddFL{Inverted }& \DIFaddFL{$(0.5, 0.8, 1.0, 1.3)$ }& \DIFaddFL{$\WSInvertedTR$ }& \DIFaddFL{$\WSInvertedSharpe$ }& \DIFaddFL{$\WSInvertedMDD$ }\\
\DIFaddFL{Optimized }& \DIFaddFL{$(\WSOptWtrend, \WSOptWmom, \WSOptWmr, \WSOptWvol)$ }& \DIFaddFL{$\WSOptTR$ }& \DIFaddFL{$\WSOptSharpe$ }& \DIFaddFL{$\WSOptMDD$ }\\
\DIFaddFL{Inv.-variance }& \DIFaddFL{$(\WSIvWtrend, \WSIvWmom, \WSIvWmr, \WSIvWvol)$ }& \DIFaddFL{$\WSIvTR$ }& \DIFaddFL{$\WSIvSharpe$ }& \DIFaddFL{$\WSIvMDD$ }\\
\DIFaddFL{Buy-and-hold }& \DIFaddFL{-- }& \DIFaddFL{$\BHtest$ }& \DIFaddFL{$\BHsharpe$ }& \DIFaddFL{$\MDDbh$ }\\
\bottomrule
\end{tabular}
\end{table}

\DIFadd{The results support three conclusions. First, the risk-adjusted profile is robust to the weights. Across the }\WSPerturbN{} \DIFadd{perturbations the out-of-sample Sharpe ratio spans $[\WSPerturbSharpeMin{}, \WSPerturbSharpeMax{}]$ and total return spans $[\WSPerturbTRMin{}, \WSPerturbTRMax{}]$, and only }\WSFixedBelowBH{} \DIFadd{of the }\WSFixedN{} \DIFadd{fixed and theory-implied schemes fall below the buy-and-hold Sharpe ratio of }\BHsharpe{}\DIFadd{; the four volatility-weight perturbations leave every metric exactly unchanged, because the Bollinger agent is essentially inactive under the selected configuration. The baseline is not the best configuration in hindsight - moderately downweighting the momentum-family agents would have improved this particular window, consistent with the ablation finding that removing MACD helps. The two schemes below the benchmark Sharpe ratio do surrender that part of the risk-adjusted advantage, but even they keep the maximum drawdown markedly shallower than the buy-and-hold }\MDDbh{}\DIFadd{, so the drawdown-reduction profile - the central risk-adjusted finding of the paper - survives every weighting scheme even where the Sharpe advantage does not. Second, in-sample optimization adds little. The grid-optimized weights land almost exactly on the fixed prior (only the momentum weight moves, from $1.0$ to $\WSOptWmom{}$), and their out-of-sample total return of }\WSOptTR{} \DIFadd{is within about two percentage points of the baseline; on the FTSE~100 the optimized weights actually }\emph{\DIFadd{underperform}} \DIFadd{the fixed prior out of sample (}\FtseWSOptTR{} \DIFadd{against }\FtseTRtest{} \DIFadd{total return), a direct instance of the forecast combination puzzle, in which the estimation error of fitted weights consumes the gains they promise \mbox{%DIFAUXCMD
\cite{smithwallis2009,claeskens2016}}\hskip0pt%DIFAUXCMD
. Third, the inverse-variance prescription is uninformative here: because the per-family directional hit rates are nearly identical (Section~\ref{subsec:confvalid}), the estimated weights come out close to equal ($\WSIvWtrend{}$, $\WSIvWmom{}$, $\WSIvWmr{}$, $\WSIvWvol{}$ for trend, momentum, mean reversion, and volatility), and the resulting performance is practically identical to the equal-weight scheme. The FTSE~100 replication of the full experiment shows the same qualitative pattern, with perturbation Sharpe ratios spanning $[\FtseWSPerturbSharpeMin{}, \FtseWSPerturbSharpeMax{}]$ and }\FtseWSFixedBelowBH{} \DIFadd{of }\FtseWSFixedN{} \DIFadd{fixed schemes below the buy-and-hold Sharpe ratio. Together with the leave-one-agent-out ablation, these results indicate that the contribution of the ensemble does not hinge on the particular weight values, and that the coarse fixed prior is defensible against perturbed, reordered, optimized, and theory-implied alternatives.
}

\subsection{\DIFadd{Comparison with Machine-Learning Baselines}}
\DIFaddend \label{subsec:lstm_results}

Table~\ref{tab:lstm} compares the ensemble with the \DIFdelbegin \DIFdel{LSTM directional baseline }\DIFdelend \DIFaddbegin \DIFadd{two machine-learning baselines }\DIFaddend of Section~\ref{subsec:lstm} on the held-out WIG20 test window. The LSTM earns a total return of \LSTMtest{} at a Sharpe ratio of \LSTMsharpe{}, against \TRtest{} and \Shtest{} for the ensemble and \BHtest{} and \BHsharpe{} for buy-and-hold. The ensemble exceeds the LSTM on total return, Sharpe ratio, and maximum drawdown (\MDDtest{} against \LSTMmdd{}), and it does so while placing far fewer trades (\Ntrades{} against \LSTMtrades{}). The one-sided paired bootstrap $p$-values for the ensemble exceeding the LSTM are \PensVsLSTM{} on total return and \PensVsLSTMsharpe{} on Sharpe ratio; as with the buy-and-hold comparison, the point-estimate advantage is sizable but does not reach the conventional $p < 0.05$ threshold on a single test window.
\DIFdelbegin \DIFdel{The learned classifier, trained end-to-end on the same price history and executed under identical costs, does not match }\DIFdelend \DIFaddbegin 

\DIFadd{The GBM baseline behaves similarly. It earns }\GBMtest{} \DIFadd{at a Sharpe ratio of }\GBMsharpe{} \DIFadd{over }\GBMtrades{} \DIFadd{closed trades; its equity path is statistically indistinguishable from the LSTM's (paired one-sided $p = \PGBMvsLSTM{}$ on total return), and the ensemble leads it on total return, Sharpe ratio, and Calmar ratio (one-sided $p = \PensVsGBM{}$ on total return and $p = \PensVsGBMsharpe{}$ on Sharpe ratio). The single metric on which the GBM edges ahead is the maximum drawdown (}\GBMmdd{} \DIFadd{against }\MDDtest{}\DIFadd{), but this reflects an almost flat equity curve rather than better risk control: the model takes very little risk and earns correspondingly little, which is exactly what the Calmar ratio registers (}\GBMcalmar{} \DIFadd{against }\Calmtest{}\DIFadd{). The fact that two structurally different learners - a recurrent neural network and a gradient-boosted tree ensemble, each tuned strictly in-sample under the identical protocol - arrive at similarly modest out-of-sample results on this market strengthens the earlier reading: the WIG20 test window offers little exploitable signal to flexible learners, and }\DIFaddend the transparent forecast-combination ensemble \DIFdelbegin \DIFdel{on this market, which is }\DIFdelend \DIFaddbegin \DIFadd{remains competitive without any training at all, }\DIFaddend consistent with the broader finding that simple, well-regularized combinations are competitive with more flexible learners on noisy financial series \cite{clemen1989,timmermann2006}.

\begin{table}[t]
\centering
\caption{Comparison of the ensemble, the LSTM \DIFaddbeginFL \DIFaddFL{and GBM }\DIFaddendFL directional \DIFdelbeginFL \DIFdelFL{baseline}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{baselines}\DIFaddendFL , and buy-and-hold on the held-out WIG20 test window, net of transaction costs.}
\label{tab:lstm}
\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{lccc}
%DIFDELCMD < %%%
\DIFdelendFL \begin{tabular}{lcccc}
\toprule
Metric & Multi-agent \DIFdelbeginFL \DIFdelFL{system }\DIFdelendFL & LSTM \DIFdelbeginFL \DIFdelFL{baseline }\DIFdelendFL \DIFaddbeginFL & \DIFaddFL{GBM }\DIFaddendFL & Buy-and-hold \DIFdelbeginFL \DIFdelFL{WIG20 }\DIFdelendFL \\
\midrule
Total return     & $\TRtest$   & $\LSTMtest$   & \DIFaddbeginFL \DIFaddFL{$\GBMtest$   }& \DIFaddendFL $\BHtest$ \\
Sharpe ratio     & $\Shtest$   & $\LSTMsharpe$ & \DIFaddbeginFL \DIFaddFL{$\GBMsharpe$ }& \DIFaddendFL $\BHsharpe$ \\
Max drawdown     & $\MDDtest$  & $\LSTMmdd$    & \DIFaddbeginFL \DIFaddFL{$\GBMmdd$    }& \DIFaddendFL $\MDDbh$ \\
Calmar ratio     & $\Calmtest$ & $\LSTMcalmar$ & \DIFaddbeginFL \DIFaddFL{$\GBMcalmar$ }& \DIFaddendFL $\Calmbh$ \\
Number of trades & $\Ntrades$  & $\LSTMtrades$ & \DIFaddbeginFL \DIFaddFL{$\GBMtrades$ }& \DIFaddendFL -- \\
\bottomrule
\end{tabular}
\end{table}
...
\DIFaddbegin \subsection{\DIFadd{Sensitivity to the Selection Objective}}
\label{subsec:objective}

\DIFadd{The headline protocol selects $(m^\star, c^\star)$ by in-sample total return (Section~\ref{subsec:walkforward}), which invites the question whether a risk-adjusted objective would have selected a different configuration. To answer it, the identical training-window grid is re-ranked under two risk-adjusted objectives, the Sharpe ratio and the Calmar ratio, and the winning configuration of each is evaluated untouched on the held-out window. On WIG20, all three objectives select the same configuration, (\ObjSharpeMode{}, $c_{\min} = \ObjSharpeMinConf{}$), and the FTSE~100 replication behaves identically, selecting (\FtseObjSharpeMode{}, $c_{\min} = \FtseObjSharpeMinConf{}$) under every objective. Every out-of-sample number reported in this paper is therefore invariant to replacing the total-return objective with a risk-adjusted one on both markets. The mechanism is visible in Table~\ref{tab:grid_train}: the }\emph{\DIFadd{passive}} \DIFadd{configurations never trade and the }\emph{\DIFadd{balanced}} \DIFadd{configurations trade too rarely to compete on either cumulative return or ratio statistics, so the argmax falls inside the }\emph{\DIFadd{aggressive}} \DIFadd{column under every objective. This invariance cannot be assumed in general - it may fail on grids with more degrees of freedom or on longer menus of modes - but on the present design it confirms that the choice of a simple, low-variance selection objective (Section~\ref{subsec:walkforward}) is not load-bearing, consistent with the estimation-noise argument for avoiding ratio objectives on short training samples \mbox{%DIFAUXCMD
\cite{lo2002}}\hskip0pt%DIFAUXCMD
.
}

\DIFaddend \subsection{External Validation on the FTSE 100}
\label{subsec:ftse}

To test whether the risk-aware profile of the ensemble is specific to the WSE or transfers to a different market structure, we replicate the entire pipeline on the FTSE~100 panel described in Section~\ref{subsec:dataset}. The transaction-cost model is adjusted to reflect UK conditions: a proportional commission of $5$ bps and one-way slippage of $5$ bps on every trade, plus a $50$ bps Stamp Duty Reserve Tax charged on purchases only, which makes the FTSE cost environment asymmetric and, on the buy side, considerably more punitive than the WIG20 calibration. The decision-agent grid, the indicator hyperparameters, and every evaluation procedure are held identical; only the market data and the cost model change.
...
\DIFdelendFL \begin{tabular}{lcccc}
\toprule
Metric & Multi-agent system & LSTM baseline & \DIFaddbeginFL \DIFaddFL{GBM baseline }& \DIFaddendFL Buy-and-hold FTSE \\
\midrule
Total return     & $\FtseTRtest$ $[\FtseTRtestCIlow, \FtseTRtestCIhigh]$ & $\FtseLSTMtest$   & \DIFaddbeginFL \DIFaddFL{$\FtseGBMtest$ }& \DIFaddendFL $\FtseBHtest$ \\
CAGR             & $\FtseCAGR$    & --              & \DIFaddbeginFL \DIFaddFL{-- }& \DIFaddendFL $\FtseBHcagr$ \\
Sharpe ratio     & $\FtseSharpe$ $[\FtseSharpeCIlow, \FtseSharpeCIhigh]$ & $\FtseLSTMsharpe$ & \DIFaddbeginFL \DIFaddFL{$\FtseGBMsharpe$ }& \DIFaddendFL $\FtseBHsharpe$ \\
Max drawdown     & $\FtseMDD$     & $\FtseLSTMmdd$  & \DIFaddbeginFL \DIFaddFL{$\FtseGBMmdd$ }& \DIFaddendFL $\FtseBHmdd$ \\
Calmar ratio     & $\FtseCalmar$  & --              & \DIFaddbeginFL \DIFaddFL{$\FtseGBMcalmar$ }& \DIFaddendFL $\FtseBHcalmar$ \\
Sortino ratio    & $\FtseEnsSortino$ & --           & \DIFaddbeginFL \DIFaddFL{-- }& \DIFaddendFL $\FtseBHSortino$ \\
Ulcer Index      & $\FtseEnsUlcer$   & --           & \DIFaddbeginFL \DIFaddFL{-- }& \DIFaddendFL $\FtseBHUlcer$ \\
Number of trades & $\FtseNtrades$ & $\FtseLSTMtrades$ & \DIFaddbeginFL \DIFaddFL{$\FtseGBMtrades$ }& \DIFaddendFL -- \\
\bottomrule
\end{tabular}
...
\DIFaddbegin \DIFadd{The confidence-validation experiment (Section~\ref{subsec:confvalid}) sharpens what this theoretical connection does and does not claim. Because the confidence values turn out to carry no measurable information about signal-level accuracy, the inverse-variance reading of \eqref{eq:score} must be understood as the conceptual motivation for the architecture rather than as a calibrated statistical mechanism; what the data support is the weaker and more robust half of the theory, namely that pooling forecasters with imperfectly correlated errors reduces the variance of the combined position, regardless of how the pool is weighted. The weight-sensitivity results reinforce this reading from the other side: near-equal (inverse-variance) weights, equal weights, and the fixed prior all deliver similar out-of-sample performance, exactly as the forecast-combination literature predicts for combinations whose members have similar individual accuracy \mbox{%DIFAUXCMD
\cite{clemen1989,smithwallis2009}}\hskip0pt%DIFAUXCMD
. In short, the empirical content of the theory in this application is error diversity, not precision weighting, and the paper's claims are framed accordingly.
}

\DIFaddend \subsection{Evidence for the Three Hypotheses}

The headline results, read together with the risk-adjusted table, the volatility-matched table, and the regime decomposition, are consistent with H1. On the aggregate test window, the ensemble trails buy-and-hold on gross total return by $\BullShortfallPP{}$ percentage points in the bull regime, more than enough to explain the aggregate shortfall, but on point estimates it leads buy-and-hold on every risk-adjusted metric considered: Sharpe ($\Shtest{}$ vs.\ $\BHsharpe{}$), Sortino ($\EnsSortino{}$ vs.\ $\BHSortino{}$), Calmar ($\Calmtest{}$ vs.\ $\Calmbh{}$), Ulcer Index ($\EnsUlcer{}$ vs.\ $\BHUlcer{}$), Martin ratio ($\EnsMartin{}$ vs.\ $\BHMartin{}$), and maximum drawdown ($\MDDtest{}$ vs.\ $\MDDbh{}$). Once the two series are matched on ex-ante volatility, the ensemble also leads buy-and-hold on total return, by $\VolScaledExcessPP{}$ percentage points, with materially smaller drawdown. As the significance analysis in Section~\ref{subsec:significance} makes clear, these advantages are point-estimate-level and do not attain conventional statistical significance on a single sub-two-year window, so we read them as consistent and economically meaningful rather than as statistical dominance. The FTSE 100 replication in Section~\ref{subsec:ftse} yields the same qualitative H1 pattern on \FtseOOSDays{} held-out trading days under UK-specific costs, supporting external validity even though the formal hypothesis is stated against WIG20. These observations \DIFdelbegin \DIFdel{instantiate }\DIFdelend \DIFaddbegin \DIFadd{are consistent with }\DIFaddend the variance-reduction prediction of forecast-combination theory: the combination of heterogeneous directional forecasts lowers the variance of the equity curve, and the reduction is visible both in the volatility and in the drawdown profile.
...
The ablation strongly supports H3. Removing any single signal agent moves the total return on the test window within a narrow band around the full ensemble, and the worst leave-one-out configuration still achieves a total return above $0.19$, a Sharpe ratio above $1$, and a Sortino ratio above buy-and-hold. Two observations deserve particular mention. First, removing the momentum family (MACD) slightly improves the headline metrics on this test window, which indicates that the pre-set family weights overweight momentum relative to what this particular period demands; \DIFdelbegin \DIFdel{in a more conservative future version, the family weights could be learned rather than fixed}\DIFdelend \DIFaddbegin \DIFadd{the weight-sensitivity analysis of Section~\ref{subsec:weights} confirms this hindsight observation directly (downweighting momentum improves the window), while also showing that in-sample weight optimization does not reliably capture such regime-specific adjustments out of sample}\DIFaddend . Second, the Bollinger agent on its own produced very few trades under the selected configuration, so its removal has only a mild effect on the behavior of the ensemble; it behaves as a low-activity member of the forecast pool on this test window. Taken together, these findings show that the ensemble is robust to the removal of any single signal agent, consistent with the forecast-combination prediction that variance reduction persists as long as at least two imperfectly correlated forecasters remain. \DIFaddbegin \DIFadd{The weight-sensitivity analysis extends this robustness from the roster of agents to the weights themselves: no perturbation, reordering, or data-driven re-estimation of the family weights changes the qualitative conclusion.
}\DIFaddend 
...
\DIFaddbegin \DIFadd{Beyond the two markets studied here, three considerations delimit how far the results should be extrapolated. First, the profitability of technical trading rules varies systematically across markets and erodes as markets mature: survey evidence reports stronger rule profitability in emerging and less liquid markets and weakening evidence in developed ones once transaction costs and data-snooping adjustments are applied \mbox{%DIFAUXCMD
\cite{parkirwin2007}}\hskip0pt%DIFAUXCMD
, and classic evidence from Asian markets ties rule profitability to the level of market development and trading frictions \mbox{%DIFAUXCMD
\cite{bessembinderchan1995}}\hskip0pt%DIFAUXCMD
. On this spectrum, the present results are consistent with two moderately mature markets in which naive signal-chasing no longer pays - every single-agent baseline is unprofitable or marginal, and neither learned baseline achieves a statistically significant edge - but a disciplined, diversified risk overlay still adds risk-adjusted value. We would accordingly expect the gross-return picture to be more favorable to the ensemble in less efficient, higher-friction markets, and the risk-control profile to be the more portable component in highly developed ones. Second, the transferable part of the framework is structural rather than numerical. The agent interfaces, the anchored walk-forward protocol, the calibrated cost model, and the evaluation battery apply unchanged to any market with reliable daily closes - the FTSE replication required only a new data source and cost model - whereas the specific calibrations (thresholds, weights, commissions, taxes) must be re-derived per market, as the asymmetric UK stamp duty illustrates. Third, the value added by the ensemble is regime-dependent, concentrated in corrections and sideways phases, so its realized advantage in any market will track the regime composition of the evaluation window; markets or periods dominated by persistent bull regimes mechanically favor passive exposure, as both test windows here illustrate. Mapping the framework's domain of validity across further developed and emerging indices, as outlined in Section~\ref{sec:limitations}, is therefore the most direct extension of this study.
}
...
Two operational considerations follow from this framing. The first concerns the update cadence. The five agents and the decision agent consume only end-of-day closes, so a retail deployment amounts to running the pipeline once after the daily WSE close and acting on the resulting recommendations at the open or close of the following session. No intraday infrastructure, tick data, or order-book integration is required, which lowers the bar for adoption outside the institutional segment. The second concerns monitoring. Because the decision-agent score in \eqref{eq:score} is a linear combination of agent signals weighted by confidence and family, the score can be decomposed, day by day, into per-agent contributions and plotted alongside the equity curve. This decomposition gives the investor an interpretable audit trail of which agents drove each position change, and makes it straightforward to detect structural shifts in the signal distribution (for example, an agent whose confidence collapses for an extended period) without retraining the ensemble. We view this interpretability as a distinctive strength of a \DIFdelbegin \DIFdel{theory-grounded }\DIFdelend \DIFaddbegin \DIFadd{theory-motivated }\DIFaddend forecast-combination design relative to end-to-end deep-reinforcement-learning trading systems, which typically produce a scalar action without a transparent attribution to individual input signals. This strength \DIFdelbegin \DIFdel{does not come at the cost of }\DIFdelend \DIFaddbegin \DIFadd{comes at little cost in }\DIFaddend performance on the markets studied here\DIFdelbegin \DIFdel{: the LSTM directional baseline }\DIFdelend \DIFaddbegin \DIFadd{. On WIG20 the ensemble leads both the LSTM and GBM directional baselines }\DIFaddend of Section~\ref{subsec:lstm} \DIFdelbegin \DIFdel{, a representative }\DIFdelend \DIFaddbegin \DIFadd{- two structurally different }\DIFaddend learning-based \DIFdelbegin \DIFdel{competitor }\DIFdelend \DIFaddbegin \DIFadd{competitors }\DIFaddend trained on the same price history and executed under identical costs \DIFdelbegin \DIFdel{, does not beat the transparent ensemble by a statistically significant margin on either market. On WIG20 the ensemble dominates it on every metric }\DIFdelend \DIFaddbegin \DIFadd{- on total return and on every risk-adjusted ratio, notwithstanding the marginally shallower drawdown that the GBM achieves by barely taking any risk at all }\DIFaddend (Section~\ref{subsec:lstm_results})\DIFdelbegin \DIFdel{; on }\DIFdelend \DIFaddbegin \DIFadd{. On }\DIFaddend the FTSE 100 the \DIFdelbegin \DIFdel{LSTM posts }\DIFdelend \DIFaddbegin \DIFadd{learned models post }\DIFaddend higher point estimates, \DIFdelbegin \DIFdel{but }\DIFdelend \DIFaddbegin \DIFadd{and the GBM's total-return gap is marginally significant on that single window, but they achieve this }\DIFaddend only by remaining near-fully invested through an almost pure bull window, which leaves \DIFdelbegin \DIFdel{it }\DIFdelend \DIFaddbegin \DIFadd{them }\DIFaddend statistically indistinguishable from passive buy-and-hold while giving up the drawdown control that motivates the ensemble (Section~\ref{subsec:ftse}). The ensemble thus retains full per-signal attribution while remaining competitive \DIFdelbegin \DIFdel{with an opaque learned model}\DIFdelend \DIFaddbegin \DIFadd{on the risk axis with opaque learned models}\DIFaddend .

\subsection{Deployment and Scalability}
\label{subsec:deployment}

Several practical considerations determine whether the system can be deployed beyond a backtest, and the transparent design has favorable properties on most of them. \emph{Computational cost.} Decision-time inference is non-iterative: each signal agent is a closed-form indicator computed over a rolling window, updated incrementally per symbol, and the decision agent reduces the per-symbol signals to a single confidence-weighted sum followed by a threshold comparison, as in \eqref{eq:score}. There is no model training, no gradient computation, and no specialized hardware at decision time; one pass over the day's closing prices on a commodity CPU suffices. This contrasts with the LSTM \DIFdelbegin \DIFdel{baseline }\DIFdelend \DIFaddbegin \DIFadd{and GBM baselines }\DIFaddend of Section~\ref{subsec:lstm} and with end-to-end deep-reinforcement-learning systems, which require training and periodic retraining. \emph{Scalability across symbols and markets.} The total work per day is of order $O(N_\text{symbols} \times N_\text{agents})$, linear in the size of the traded universe, and it is embarrassingly parallel because each agent processes the history of a single symbol independently through the shared base-agent interface. The FTSE 100 study of Section~\ref{subsec:ftse} is concrete evidence of market portability: re-pointing the entire pipeline at a different exchange is a configuration change, comprising a new data source and cost model, rather than a change to the agents or the decision layer. \emph{Liquidity.} The evaluation trades only large-capitalization index constituents at the daily close, and the selected configuration is low-turnover, so the resting-order footprint is small at retail size; price impact, partial fills, and order-book dynamics are not modeled and are discussed as a limitation in Section~\ref{sec:limitations}. \emph{Execution latency.} Because signals are computed once after the close and acted on at the next session, the design tolerates latencies of seconds to minutes and requires no co-location, tick data, or order-book integration, which places it at the opposite end of the infrastructure spectrum from high-frequency trading. \emph{Portfolio scalability and the retail-institutional distinction.} The fractional position-sizing rule scales capital mechanically, but the assumption of fills at the closing price without impact bounds the deployable capital relative to average daily volume, so the profile is most defensible at retail-to-moderate assets under management. For a retail investor the system is usable as an end-of-day decision-support overlay on a passive benchmark, without leverage or dedicated infrastructure; for an institutional user the linear scaling and market-agnostic interface make wider universes feasible, but explicit price-impact modeling and the analytical-only leverage caveat of Section~\ref{subsec:volscaled} would become binding.
...
The primary contribution of this paper is a rigorous and reusable evaluation framework, together with an in-depth empirical study of a transparent, theoretically \DIFdelbegin \DIFdel{grounded }\DIFdelend \DIFaddbegin \DIFadd{motivated }\DIFaddend ensemble that instantiates it. Read this way, the paper makes methodological, empirical, and theoretical claims about risk-aware multi-agent decision support on less-studied equity markets.

Methodologically, the evaluation pipeline - anchored walk-forward tuning of decision-agent parameters, calibrated frictions on every trade, ablation across single-agent removals, \DIFdelbegin \DIFdel{a comparison against an LSTM deep-learning baseline}\DIFdelend \DIFaddbegin \DIFadd{sensitivity analyses over the family weights and the selection objective, an empirical audit of the confidence heuristic, comparisons against LSTM and gradient-boosted-tree baselines}\DIFaddend , regime decomposition, a wide cost-sensitivity sweep, and bootstrap significance tests - closes the four gaps identified in Section~\ref{sec:introduction} and is reusable as a template for similar studies on smaller equity markets, where capital preservation in turbulent periods may matter more than chasing the next bull leg.

Empirically, the ensemble does not maximize total return on the WIG20 test window; buy-and-hold does, by virtue of a bull-dominated subperiod. Once the two series are matched on ex-ante risk, however, the ensemble earns $\VolScaledExcessPP$ percentage points more total return than buy-and-hold and improves every risk-adjusted metric reported, although these differences do not reach statistical significance on a single window. The regime decomposition shows where this comes from: $\CorrectionDefencePP$ percentage points of correction-regime defense and $\SidewaysExcessPP$ percentage points of sideways-regime carry, paid for by an underperformance in the bull phase that the fixed-weight design cannot fully recover. The ablation and cost-sensitivity sweep both indicate that this profile is not an artifact of a single agent or of a particular friction calibration, and the external validation on the FTSE 100 reproduces the same qualitative pattern under a different market structure and cost regime, indicating that the finding is not specific to the WSE sample.

Theoretically, the system supplies \DIFdelbegin \DIFdel{an }\DIFdelend \DIFaddbegin \DIFadd{a deliberately qualified }\DIFaddend empirical instance of the forecast-combination argument on an actual market\DIFdelbegin \DIFdel{: the }\DIFdelend \DIFaddbegin \DIFadd{. The }\DIFaddend pairwise correlations of the five agents span $\CorrMin$ to $\CorrMax$, satisfying the non-identical-errors assumption \DIFdelbegin \DIFdel{that motivates }\DIFdelend \DIFaddbegin \DIFadd{behind }\DIFaddend the variance-reduction prediction in \eqref{eq:combined_variance}\DIFdelbegin \DIFdel{. The }\DIFdelend \DIFaddbegin \DIFadd{, and the }\DIFaddend observed risk reduction is \DIFdelbegin \DIFdel{therefore not opportunistic but consistent with the theoretical baseline of Section~\ref{sec:theory}}\DIFdelend \DIFaddbegin \DIFadd{consistent with that prediction. At the same time, the confidence heuristic does not behave as a calibrated inverse-variance estimate (Section~\ref{subsec:confvalid}), so the connection to classical forecast-combination theory is conceptual: it correctly anticipates the benefit of pooling heterogeneous signals, while its precision-weighting refinement finds no support in these data - a distinction the paper states explicitly rather than leaving implicit}\DIFaddend .

The directions outlined in Section~\ref{sec:limitations} - cross-market generalization, intraday frequencies, fundamental and alternative data, \DIFdelbegin \DIFdel{learned and }\DIFdelend regime-conditional family weights \DIFaddbegin \DIFadd{and calibrated confidence estimates}\DIFaddend , and a live paper-trading exercise - are the natural extensions to leverage these contributions in the next iteration of the system.
