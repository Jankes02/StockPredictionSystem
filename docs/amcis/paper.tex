...
It is worth noting that every set of parameters resulting in a total return lower than buy-and-hold WIG20 index strategy is suboptimal. This issue will be discussed in subsection \hyperref[sub:interpretation]{Interpretation of Results}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{equity_curves.png}
    \caption{Equity curves for system strategy and buy-and-hold WIG20}
